...
object RandomFactory {
    ...
    fun generateRandomPhoneNumber() = "${RandomFactory.generateLong(56900000000, 56999999999)}"
    fun generateRandomRut() = "${RandomFactory.generateInt(3000000, 22000000)}-${RandomFactory.generateInt(0, 11)}"
